...
test.describe('Landing Page', () => {
  test('should display Noor branding correctly', async ({ page }) => {
    await page.goto('/');

    // Verify page title contains Noor
  ...
  test('should be responsive on mobile', async ({ page }) => {
    ...
    const ctaButton = page.getByRole('link', { name: /start.*reflection/i }).first();
    await expect(ctaButton).toBeVisible();
  });
