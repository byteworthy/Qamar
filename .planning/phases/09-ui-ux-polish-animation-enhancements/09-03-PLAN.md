...
NOTE: The existing HistoryScreen has a complex item render. Wrap the existing Pressable/GlassCard structure rather than replacing it entirely.
  ...
  <verify>
- Long-press triggers scale down to 0.98 with spring physics
- Scale returns to 1 on press release
- Haptic feedback fires on long press
- Press-in provides immediate visual feedback (scale down)
- Existing tap and delete behaviors preserved
  </verify>
