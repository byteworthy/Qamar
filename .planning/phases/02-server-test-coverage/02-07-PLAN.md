...
must_haves:
  ...
  key_links:
    - from: "server/__tests__/stateInference.test.ts"
      ...
      via: "import inferInnerState"
      pattern: "import.*inferInnerState.*from.*stateInference"
---
...
2. Write failing tests for inferInnerState function
...
2. inferInnerState function fully tested
