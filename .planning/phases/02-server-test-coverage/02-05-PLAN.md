...
must_haves:
  ...
  key_links:
    - from: "server/__tests__/canonical-orchestrator.test.ts"
      ...
      via: "import orchestrateResponse"
      pattern: "import.*orchestrateResponse.*from.*canonical-orchestrator"
---
...
- Fail-safe: Pipeline failures → fallback responses, never propagate errors
...
2. Write failing tests for orchestrateResponse function
...
2. orchestrateResponse function fully tested
