...
<task type="auto">
  <name>Task 2: Add E2E test scripts for CI environment</name>
  <files>package.json</files>
  <action>
Add or verify E2E test scripts in package.json for CI execution. The following scripts should already exist (verify they match):
...
Note: Scripts already exist in current package.json. This task verifies they're correctly configured for CI usage.
