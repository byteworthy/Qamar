 ...
 */
export const getAdhkarByCategorySchema = z.object({
 ...
 */
export const searchAdhkarSchema = z.object({
...
export type GetAdhkarByCategoryParams = z.infer<typeof getAdhkarByCategorySchema>;
