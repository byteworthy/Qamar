 ...
 */
export const getHadithsByCollectionSchema = z
  .object({
 ...
 */
export const searchHadithsSchema = z
  .object({
 ...
 */
export const getHadithByIdSchema = z
  .object({
    id: z
      .string()
...
export type GetHadithsByCollectionParams = z.infer<
  typeof getHadithsByCollectionSchema
>;
