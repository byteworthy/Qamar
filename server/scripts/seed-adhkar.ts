...
const ADHKAR_DATA: InsertAdhkar[] = [
  ...
  // ============================================================================
  {
    ...
    repetitions: 1,
    virtue:
      "Whoever recites Ayat al-Kursi after every obligatory prayer, nothing will prevent him from entering Paradise except death. Protection from harm until evening.",
  },
  {
    id: "morning-2",
    category: "morning",
    ...
    repetitions: 3,
    virtue:
      "Nothing will harm him until evening. Reciting it three times protects from sudden harm.",
  },
  {
    id: "morning-3",
    category: "morning",
    ...
    repetitions: 3,
    virtue:
      "Allah has guaranteed Paradise for whoever says this with certainty three times in the morning or evening.",
  },
  {
    id: "morning-4",
    category: "morning",
    ...
    repetitions: 100,
    virtue:
      "Whoever says this 100 times in a day, their sins will be forgiven even if they are like the foam of the sea.",
  },
  {
    id: "morning-5",
    category: "morning",
    ...
    repetitions: 1,
    virtue:
      "Comprehensive morning supplication seeking Allah's protection and blessings.",
  },
  {
    id: "morning-6",
    category: "morning",
    ...
    repetitions: 4,
    virtue:
      "Allah frees a quarter of the person from Hellfire with each recitation. Four times means complete freedom.",
  },
  {
    id: "morning-7",
    category: "morning",
  ...
  },
  {
    ...
    repetitions: 7,
    virtue:
      "Allah will suffice you in whatever concerns you of this world and the Hereafter.",
  },
  {
    id: "morning-11",
    category: "morning",
    ...
    repetitions: 10,
    virtue:
      "Equivalent to freeing ten slaves, 100 good deeds recorded, 100 sins erased, protection from Satan until evening.",
  },
  {
    id: "morning-12",
    category: "morning",
  ...
  },
  {
    ...
    category: "morning",
    arabic:
      "أَصْبَحْنَا عَلَى فِطْرَةِ الإِسْلاَمِ، وَعَلَى كَلِمَةِ الإِخْلاَصِ، وَعَلَى دِينِ نَبِيِّنَا مُحَمَّدٍ صَلَى اللهُ عَلَيْهِ وَسَلَّمَ، وَعَلَى مِلَّةِ أَبِينَا إِبْرَاهِيمَ حَنِيفًا مُسْلِمًا وَمَا كَانَ مِنَ الْمُشْرِكِينَ",
    transliteration:
    ...
    translation:
      "We have entered the morning upon the natural religion of Islam, the word of sincere devotion, the religion of our Prophet Muhammad (peace be upon him), and the way of our father Ibrahim, who turned away from all that is false, having surrendered to Allah, and he was not of the polytheists.",
  ...
  },
  {
    ...
    transliteration:
      "Astaghfirullaha al-ladhi la ilaha illa Huwal-Hayyul-Qayyumu wa atubu ilayh.",
    translation:
      "I seek the forgiveness of Allah, there is no god but He, the Ever-Living, the Sustainer, and I repent to Him.",
  ...
  // ============================================================================
  {
    ...
    repetitions: 1,
    virtue:
      "Protection until morning. A guardian from Allah will be with you and Satan will not approach you.",
  },
  {
    id: "evening-2",
    category: "evening",
  ...
  },
  {
    ...
    repetitions: 3,
    virtue:
      "Allah has guaranteed Paradise for whoever says this with certainty.",
  },
  {
    id: "evening-4",
    category: "evening",
  ...
  },
  {
    ...
    category: "evening",
    arabic:
      "أَمْسَيْنَا عَلَى فِطْرَةِ الإِسْلاَمِ، وَعَلَى كَلِمَةِ الإِخْلاَصِ، وَعَلَى دِينِ نَبِيِّنَا مُحَمَّدٍ صَلَى اللهُ عَلَيْهِ وَسَلَّمَ، وَعَلَى مِلَّةِ أَبِينَا إِبْرَاهِيمَ حَنِيفًا مُسْلِمًا وَمَا كَانَ مِنَ الْمُشْرِكِينَ",
    transliteration:
    ...
    translation:
      "We have entered the evening upon the natural religion of Islam, the word of sincere devotion, the religion of our Prophet Muhammad (peace be upon him), and the way of our father Ibrahim, who turned away from all that is false, having surrendered to Allah, and he was not of the polytheists.",
    reference: "Ahmad 3/406, 407",
    repetitions: 1,
  ...
  },
  {
    ...
    repetitions: 3,
    virtue:
      "Protection until morning. Equals one-third of the Quran in reward.",
  },
  {
    id: "evening-20",
    category: "evening",
  ...
  },
  {
    ...
    transliteration:
      "A'udhu billahi minash-shaytanir-rajim. Allahu la ilaha illa Huwa, Al-Hayyul-Qayyum...",
  ...
  },
  {
    ...
    transliteration:
      "Allahumma inni a'udhu bika minal-bukhl, wa a'udhu bika minal-jubn, wa a'udhu bika an uradda ila ardhali-'umr, wa a'udhu bika min fitnatid-dunya wa 'adhabil-qabr.",
    translation:
      "O Allah, I seek refuge in You from miserliness, I seek refuge in You from cowardice, I seek refuge in You from being reduced to the worst stage of life, and I seek refuge in You from the trials of this world and the punishment of the grave.",
  ...
  },
  {
    ...
    repetitions: 1,
    virtue:
      "A guardian from Allah will protect you and Satan will not approach you until morning.",
  },
  {
    id: "sleep-3",
    category: "sleep",
    ...
    translation:
      "The Messenger believes in what has been revealed to him from his Lord, and so do the believers... (full verses)",
  ...
  },
  {
    ...
    transliteration:
      "Allahumma inni a'udhu biwajhikal-karim, wa kalimatika-t-tammat, min sharri ma anta akhidhun bi-nasiyatih.",
    translation:
      "O Allah, I seek refuge in Your Noble Face and Your perfect words from the evil of that which You seize by the forelock.",
  ...
  },
  {
    ...
    transliteration:
      "Allahumma khalaqta nafsi wa Anta tawaffaha, laka mamatuha wa mahyaha, in ahyaytaha fahfadh-ha, wa in amattaha faghfir laha. Allahumma inni as'alukal-'afiyah.",
    translation:
      "O Allah, You created my soul and You take it back. Unto You is its death and its life. If You let it live, protect it, and if You cause it to die, forgive it. O Allah, I ask You for well-being.",
  ...
  },
  {
    ...
    category: "sleep",
    arabic:
      "اللَّهُمَّ أَسْلَمْتُ وَجْهِي إِلَيْكَ، وَفَوَّضْتُ أَمْرِي إِلَيْكَ، وَأَلْجَأْتُ ظَهْرِي إِلَيْكَ، رَهْبَةً وَرَغْبَةً إِلَيْكَ",
    transliteration:
      "Allahumma aslamtu wajhi ilayk, wa fawwadtu amri ilayk, wa alja'tu dhahri ilayk, rahbatan wa raghbatan ilayk.",
    translation:
      "O Allah, I turn my face to You, I entrust my affair to You, I seek Your protection, fearing and hoping in You.",
  ...
  },
  {
    ...
    translation:
      "O Allah, I seek refuge in You from severe calamity, from being overtaken by misery, from evil decree, and from the gloating of enemies.",
  ...
  },
  {
    ...
    translation:
      "O Allah, I seek refuge in You from the withholding of Your blessings, from the decline of the well-being You have granted, from the suddenness of Your punishment, and from all forms of Your displeasure.",
  ...
  },
  {
    ...
    translation:
      "O Allah, I seek refuge in You from bad character, bad deeds, and evil desires.",
  ...
  // ============================================================================
  {
    ...
    translation:
      "Glory is to Him Who has subjected this to us, and we could never have it by our own efforts. And surely, to our Lord we are to return.",
  ...
  },
  {
    ...
    transliteration:
      "Allahumma inna nas'aluka fi safarina hadhal-birra wat-taqwa, wa minal-'amali ma tarda. Allahumma hawwin 'alayna safarana hadha, watwi 'anna bu'dahu. Allahumma Antas-sahibu fis-safar, wal-khalifatu fil-ahl.",
    translation:
      "O Allah, we ask You for righteousness and piety in this journey of ours, and deeds that please You. O Allah, make easy for us this journey and shorten its distance. O Allah, You are the Companion on the journey and the Guardian of the family.",
  ...
  },
  {
    ...
    transliteration:
      "Allahu Akbar, Allahu Akbar, Allahu Akbar (then recite travel dua).",
    translation:
  ...
  },
  {
    ...
    category: "travel",
    arabic:
      "لاَ إِلَهَ إِلاَّ اللهُ وَحْدَهُ لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ، آيِبُونَ تَائِبُونَ عَابِدُونَ سَاجِدُونَ لِرَبِّنَا حَامِدُونَ، صَدَقَ اللهُ وَعْدَهُ، وَنَصَرَ عَبْدَهُ، وَهَزَمَ الأَحْزَابَ وَحْدَهُ",
    transliteration:
      "La ilaha illallahu wahdahu la sharika lah, lahul-mulku wa lahul-hamd, wa Huwa 'ala kulli shay'in Qadir. Ayibuna ta'ibuna 'abiduna sajiduna li-Rabbina hamidun. Sadaqallahu wa'dahu, wa nasara 'abdahu, wa hazamal-ahzaba wahdah.",
    translation:
  ...
  },
  {
    ...
    transliteration:
      "Allahummahdini fiman hadayt, wa 'afini fiman 'afayt, wa tawallani fiman tawallayt.",
    translation:
  ...
  },
  {
    ...
    transliteration:
      "Allahumma inni a'udhu bika min wa'tha'is-safar, wa ka'abatil-mandhar, wa su'il-munqalabi fil-mali wal-ahl.",
    translation:
      "O Allah, I seek refuge in You from the difficulties of travel, from an unhappy change of circumstances, and from a bad return in property and family.",
    reference: "Muslim 2/978",
    repetitions: 1,
  ...
  },
  {
    ...
    translation:
      "O Allah, bless us in our journey and make the earth easy to traverse for us.",
  ...
  },
  {
    ...
    category: "travel",
    arabic:
      "اللَّهُمَّ إِنَّا نَسْأَلُكَ مِنْ خَيْرِ هَذَا الْمَكَانِ، وَنَعُوذُ بِكَ مِنْ شَرِّهِ",
    transliteration:
      "Allahumma inna nas'aluka min khayri hadhal-makan, wa na'udhu bika min sharrih.",
    translation:
      "O Allah, we ask You for the goodness of this place and seek refuge in You from its evil.",
  ...
  },
  {
    ...
    translation:
      "Praise is to Allah Who has fed me this and provided it for me without any might or power from myself.",
  ...
  },
  {
    ...
    category: "eating",
    arabic:
      "الْحَمْدُ لِلَّهِ حَمْدًا كَثِيرًا طَيِّبًا مُبَارَكًا فِيهِ، غَيْرَ مَكْفِيٍّ وَلاَ مُوَدَّعٍ وَلاَ مُسْتَغْنىً عَنْهُ رَبَّنَا",
    transliteration:
      "Alhamdulillahi hamdan kathiran tayyiban mubarakan fih, ghayra makfiyyin wa la muwadda'in wa la mustaghnan 'anhu Rabbana.",
    translation:
      "Praise is to Allah, an abundant, pure, and blessed praise. He is not to be thanked sufficiently, nor can He be left, nor can He be dispensed with, our Lord.",
  ...
  },
  {
    ...
    category: "eating",
    arabic:
      "اللَّهُمَّ أَطْعَمْتَ وَسَقَيْتَ، وَأَشْبَعْتَ وَأَرْوَيْتَ، فَلَكَ الْحَمْدُ غَيْرَ مَكْفِيٍّ وَلاَ مَكْفُورٍ",
    transliteration:
      "Allahumma at'amta wa saqayt, wa ashba'ta wa arwayt, falakal-hamdu ghayra makfiyyin wa la makfur.",
    translation:
      "O Allah, You have fed and given drink, satisfied and quenched, so praise is to You, a praise that is neither insufficient nor unworthy.",
  ...
  },
  {
    ...
    translation:
      "My Lord, expand my chest, make my task easy for me, and untie the knot from my tongue that they may understand my speech.",
  ...
  },
  {
    ...
    category: "general",
    arabic:
      "رَبَّنَا اغْفِرْ لَنَا وَلِإِخْوَانِنَا الَّذِينَ سَبَقُونَا بِالإِيمَانِ وَلاَ تَجْعَلْ فِي قُلُوبِنَا غِلاًّ لِّلَّذِينَ آمَنُوا رَبَّنَا إِنَّكَ رَءُوفٌ رَّحِيمٌ",
    transliteration:
      "Rabbanagh-fir lana wa li-ikhwaninal-ladhina sabaquna bil-imani wa la taj'al fi qulubina ghillan lil-ladhina amanu Rabbana innaka Ra'ufun Rahim.",
    translation:
  ...
  },
  {
    ...
    transliteration:
      "Rabbigh-fir li wa li-walidayya warhamhuma kama rabbayani saghira.",
    translation:
  ...
  },
  {
    ...
    transliteration:
      "Allahumma inni dhalamtu nafsi dhulman kathira, wa la yaghfirudh-dhunuba illa Ant, faghfir li maghfiratan min 'indik, warhamni innaka Antal-Ghafur-ur-Rahim.",
    translation:
  ...
  },
  {
    ...
    translation:
      "O Allah, I ask You for doing good deeds, leaving evil deeds, and love for the poor.",
  ...
  },
  {
    ...
    category: "general",
    arabic:
      "اللَّهُمَّ إِنِّي أَسْأَلُكَ مِنَ الْخَيْرِ كُلِّهِ عَاجِلِهِ وَآجِلِهِ، مَا عَلِمْتُ مِنْهُ وَمَا لَمْ أَعْلَمْ، وَأَعُوذُ بِكَ مِنَ الشَّرِّ كُلِّهِ",
    transliteration:
      "Allahumma inni as'aluka minal-khayri kullihi 'ajilihi wa ajilihi, ma 'alimtu minhu wa ma lam a'lam. Wa a'udhu bika minash-sharri kullihi.",
    translation:
      "O Allah, I ask You for all that is good, in this world and in the Hereafter, what I know of it and what I do not know. And I seek refuge in You from all evil.",
  ...
  },
  {
    ...
    transliteration:
      "Allahummaj'alni sabura, waj'alni shakura, waj'alni fi 'ayni saghira, wa fi a'yunin-nasi kabira.",
    translation:
      "O Allah, make me patient, make me grateful, make me small in my own eyes, and great in the eyes of people.",
  ...
  },
  {
    ...
    translation:
      "O Allah, bestow Your favor on Muhammad and on the family of Muhammad as You have bestowed Your favor on Ibrahim. You are Praiseworthy, Most Glorious. O Allah, bless Muhammad and the family of Muhammad as You have blessed Ibrahim. You are Praiseworthy, Most Glorious.",
...
export async function seedAdhkar() {
  try {
    ...
    const categoryCounts = ADHKAR_DATA.reduce(
      (acc, item) => {
