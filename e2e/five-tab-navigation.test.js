 ...
 *
 * Tests the extended 5-tab navigation system for the Qamar app merger.
 *
 * Tab Structure:
...
describe("5-Tab Navigation System", () => {
  ...
  describe("Tab Navigation", () => {
    ...
    it("should navigate to Learn tab", async () => {
      ...
      await expect(
        element(by.text("Islamic knowledge and Arabic language")),
      ).toBeVisible();
    });
    ...
    it("should navigate to Worship tab", async () => {
      ...
      await expect(
        element(by.text("Prayer times, Qibla, and daily adhkar")),
      ).toBeVisible();
    });
  ...
  describe("Learn Tab Features", () => {
    ...
    it("should display Quran Reader card", async () => {
      ...
      await expect(
        element(by.text("Read and explore the Holy Quran with translations")),
      ).toBeVisible();
    });
    ...
    it("should display Arabic Learning card", async () => {
      ...
      await expect(
        element(by.text("Learn Arabic with interactive flashcards")),
      ).toBeVisible();
    });
    ...
    it("should display Hadith Library card", async () => {
      ...
      await expect(
        element(by.text("Browse authenticated Hadith collections")),
      ).toBeVisible();
    });
  ...
  describe("Worship Tab Features", () => {
    ...
    it("should display Prayer Times card", async () => {
      ...
      await expect(
        element(by.text("Accurate prayer times for your location")),
      ).toBeVisible();
    });
    ...
    it("should display Qibla Finder card", async () => {
      ...
      await expect(
        element(by.text("Find the direction of Makkah")),
      ).toBeVisible();
    });
    ...
    it("should display Adhkar & Duas card", async () => {
      ...
      await expect(
        element(by.text("Daily remembrance and supplications")),
      ).toBeVisible();
    });
    ...
    it("should display Islamic Calendar card", async () => {
      ...
      await expect(
        element(by.text("Hijri dates and important events")),
      ).toBeVisible();
    });
