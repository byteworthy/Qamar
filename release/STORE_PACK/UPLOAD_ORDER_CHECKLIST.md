...
1. **Privacy Policy URL** → Paste: `https://byteworthy.github.io/noor-legal/privacy-policy`
2. **Terms of Service URL** (if field exists) → Paste: `https://byteworthy.github.io/noor-legal/terms-of-service`
