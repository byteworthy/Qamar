# Noor App Store Listing - FINAL APPROVED
...
Private AI journaling for reflection and clarity.
...
Noor is a self-reflection and journaling app.
It does not provide medical advice, diagnosis, or treatment.
It is not designed for crisis use.
AI is used only to generate reflective responses based on user input.
...
✓ No crisis intervention claims
✓ No HIPAA language
✓ AI usage disclosed
✓ AI limitations disclosed
✓ Privacy claims match Privacy Policy
✓ Emergency disclaimer present
✓ Adult audience appropriate
✓ Matches legal/APP_STORE_LEGAL_TEXT.md
