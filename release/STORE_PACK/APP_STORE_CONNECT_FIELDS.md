...
- Violence: No (cartoon, realistic, or graphic: None)
...
| Contact Info (Email) | Yes (optional) | Yes | No |
| Health & Fitness | No | - | - |
| Financial Info | No | - | - |
| Location | No | - | - |
| Sensitive Info | No | - | - |
...
### Privacy Questionnaire Selections
...
- "Does your app qualify for exemption?" → Yes (standard HTTPS/TLS)
- "Is your app available outside the US?" → Yes
- Export compliance documentation → Not required for HTTPS exemption

**Action Required:** Confirm with legal/compliance that HTTPS-only qualifies for exemption before answering definitively.
...
**Status:** Ready for paste into App Store Connect
