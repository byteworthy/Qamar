...
export const BADGE_DEFINITIONS: Badge[] = [
  { id: "first_light", name: "First Light", description: "Complete your first Daily Qamar", icon: "star", earnedAt: null },
  ...
  { id: "early_bird", name: "Early Bird", description: "Complete Daily Qamar before Dhuhr 7 times", icon: "clock", earnedAt: null },
