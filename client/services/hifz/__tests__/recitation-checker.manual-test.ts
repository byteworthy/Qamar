...
console.log(
  `All words correct:`,
  result2.wordResults.every((w) => w.isCorrect),
);
console.log();
...
console.log(
  `Score: ${result3.score}%, Accuracy: ${result3.accuracy.toFixed(2)}`,
);
console.log(
  `Word Results:`,
  result3.wordResults.map((w) => ({
    expected: w.expected,
    actual: w.actual,
    correct: w.isCorrect,
  })),
...
const result4 = checkRecitation(1, 1, "بسم الله الرحمن الرحيم", "");
...
console.log(
  `Score: ${result5.score}%, Accuracy: ${result5.accuracy.toFixed(2)}`,
);
console.log(
  `Word Results:`,
  result5.wordResults.map((w) => ({
    expected: w.expected,
    actual: w.actual,
    correct: w.isCorrect,
  })),
