...
describe('WorshipTabScreen', () => {
  ...
  describe('Rendering', () => {
    ...
    it('should render the subtitle', () => {
      ...
      expect(screen.getByText('Prayer times, Qibla, and daily adhkar')).toBeTruthy();
    });
    ...
    it('should render feature descriptions', () => {
      ...
      expect(screen.getByText('Accurate prayer times for your location')).toBeTruthy();
      expect(screen.getByText('Find the direction of Makkah')).toBeTruthy();
      expect(screen.getByText('Daily remembrance and supplications')).toBeTruthy();
  ...
  describe('Content Validation', () => {
    ...
    it('should have consistent card structure', () => {
      ...
      const cards = [
        { title: 'Prayer Times', description: 'Accurate prayer times for your location' },
        { title: 'Qibla Finder', description: 'Find the direction of Makkah' },
        { title: 'Adhkar & Duas', description: 'Daily remembrance and supplications' },
        { title: 'Islamic Calendar', description: 'Hijri dates and important events' },
      ];
