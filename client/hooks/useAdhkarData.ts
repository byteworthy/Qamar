...
export interface Dhikr {
  ...
  category: "morning" | "evening" | "after-prayer" | "general" | "sleep" | "protection";
}
...
const ADHKAR_DATA: AdhkarCategory[] = [
  {
    ...
    adhkar: [
      ...
      },
      {
        ...
        english: "O Allah, I have entered a new morning and I call upon You and upon the bearers of Your Throne, upon Your angels and all creation to bear witness that surely You are Allah, there is no god but You alone, You have no partners, and that Muhammad is Your slave and Your Messenger.",
      ...
      },
      {
        ...
        english: "O Allah, whatever blessing has been received by me or anyone of Your creation is from You alone, You have no partner. All praise is for You and thanks is to You.",
  ...
  },
  {
    ...
    adhkar: [
      ...
      },
      {
        ...
        english: "O Allah, I have entered the evening and I call upon You and upon the bearers of Your Throne, upon Your angels and all creation to bear witness that surely You are Allah, there is no god but You alone, You have no partners, and that Muhammad is Your slave and Your Messenger.",
        reference: "Abu Dawud 4/317",
        count: 4,
        category: "evening"
      },
      {
        ...
        english: "O Allah, whatever blessing has been received by me or anyone of Your creation in this evening is from You alone, You have no partner. All praise is for You and thanks is to You.",
        reference: "Abu Dawud 4/318",
        count: 1,
        category: "evening"
      }
  ...
  },
  {
    ...
    adhkar: [
      ...
      },
      {
        ...
        english: "O Allah, I submit myself to You, entrust my affairs to You, turn my face to You, and lay myself down depending upon You, hoping in You and fearing You. There is no refuge, and no escape, except to You. I believe in Your Book that You revealed, and the Prophet whom You sent.",
  ...
  },
  {
    ...
    adhkar: [
      ...
      },
      {
        ...
        english: "O Allah, I seek refuge in You from worry and grief, from helplessness and laziness, from cowardice and miserliness, and from being overpowered by debt and from the oppression of men.",
      ...
      },
      {
        ...
        english: "O Allah, grant me well-being in my body. O Allah, grant me well-being in my hearing. O Allah, grant me well-being in my sight. There is no god but You.",
      ...
      },
      {
        ...
        english: "O Allah, I seek refuge in You from disbelief and poverty, and I seek refuge in You from the punishment of the grave. There is no god but You.",
        reference: "Abu Dawud 4/324",
        count: 3,
        category: "protection"
      },
      {
        ...
        english: "Allah is sufficient for me. There is no god but Him. In Him I put my trust, and He is the Lord of the Mighty Throne.",
  ...
  },
  {
    ...
    adhkar: [
      ...
      },
      {
        ...
        english: "Glory is to Allah and praise is to Him. Glory is to Allah, the Most Great.",
      ...
      },
      {
        ...
        english: "Glory is to Allah, and praise is to Allah, and there is no god but Allah, and Allah is the Greatest.",
...
export function useSearchAdhkar(searchQuery: string) {
  return useQuery({
    ...
    queryFn: () => {
      ...
      const results: Array<{ dhikr: Dhikr; category: AdhkarCategory }> = [];
