...
const verseCount = db.prepare("SELECT COUNT(*) as count FROM verses").get() as { count: number };
...
const verse1_1 = db.prepare("SELECT * FROM verses WHERE surah_number = 1 AND verse_number = 1").get();
console.log("\nVerse 1:1:", {
